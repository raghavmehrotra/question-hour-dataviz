...
This personalization currently takes two main forms -- it allows the user to understand how MPs from a particular state have participated in the QH over time, as well as how the user's topic compares to certain existing topics/themes.

I am hoping to extend this to include a geospatial visualization, where users can interact with a clickable map to see all the questions that MPs from a particular constituency have asked from 2000-2018. 

I had initally wanted to do a scrollytelling article, but I will focus more of my efforts on the map.
...
1. Do you anticipate rendering lags if I search a corpus of 300k+ rows x 200-300 word long text for a substring. The easiest way to do this would be to simply try, but if there are best practices to know beforehand, that would be helpful. I will also post on Ed.
2. 
3. 